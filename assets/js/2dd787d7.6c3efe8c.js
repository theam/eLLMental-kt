...
it with a package manager of your choice.`)),(0,esm/* mdx */.kt)("li",{parentName:"ol"},(0,esm/* mdx */.kt)("p",{parentName:"li"},`Install Kotlin command line compiler. Refer to
Kotlin's `,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://kotlinlang.org/docs/command-line.html"},`official guide`),` for installation instructions on your
Operating System.`)),(0,esm/* mdx */.kt)("li",{parentName:"ol"},(0,esm/* mdx */.kt)("p",{parentName:"li"},`Have Gradle installed. You can find the necessary instructions to install Gradle from
their `,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://gradle.org/install/"},`official installation guide`),`.`))),(0,esm/* mdx */.kt)("h3",{"id":"getting-the-source-code"},`Getting the Source Code`),(0,esm/* mdx */.kt)("ol",null,(0,esm/* mdx */.kt)("li",{parentName:"ol"},(0,esm/* mdx */.kt)("p",{parentName:"li"},`Fork the repository from the main GitHub page (`,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://github.com/theam/ellmental"},`theam/ellmental`),`).`)),(0,esm/* mdx */.kt)("li",{parentName:"ol"},(0,esm/* mdx */.kt)("p",{parentName:"li"},`Clone your forked repository to your local machine.`),(0,esm/* mdx */.kt)("pre",{parentName:"li"},(0,esm/* mdx */.kt)("code",{parentName:"pre"},`git clone https://github.com/<Your Username>/eLLMental.git
...
capacity is still able to follow and understand our documentation.`),(0,esm/* mdx */.kt)("p",null,`To achieve our goal we propose writing documentation following these principles:`),(0,esm/* mdx */.kt)("ol",null,(0,esm/* mdx */.kt)("li",{parentName:"ol"},`Clean and Clear`),(0,esm/* mdx */.kt)("li",{parentName:"ol"},`Simple`),(0,esm/* mdx */.kt)("li",{parentName:"ol"},`Coherent`),(0,esm/* mdx */.kt)("li",{parentName:"ol"},`Explicit`),(0,esm/* mdx */.kt)("li",{parentName:"ol"},`Attractive`),(0,esm/* mdx */.kt)("li",{parentName:"ol"},`Inclusive`),(0,esm/* mdx */.kt)("li",{parentName:"ol"},`Cohesive`)),(0,esm/* mdx */.kt)("h4",{"id":"principles"},`Principles`),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("strong",{parentName:"p"},`1. Clean and Clear`)),(0,esm/* mdx */.kt)("p",null,`Less is more. Apple is, among many others, a good example of creating clean and clear content, where visual elements are
carefully chosen to look beautiful
(e.g. `,(0,esm/* mdx */.kt)("a",{parentName:"p","href":"https://developer.apple.com/tutorials/swiftui"},`Apple's swift UI`),`) and making the reader getting the point as soon
as possible.`),(0,esm/* mdx */.kt)("p",null,`The intention of every section, paragraph, and sentence must be clear, we should avoid writing details of two different
things even when they are related.
It is better to link pages and keep the focus and the intention clear, Wikipedia is the best example on this.`),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("strong",{parentName:"p"},`2. Simple`)),(0,esm/* mdx */.kt)("p",null,`Technical writings deal with different backgrounds and expertise from the readers. We should not assume the reader knows
...
to go deeper.`),(0,esm/* mdx */.kt)("p",null,`Diagrams are great tools, you know a picture is worth more than a thousand words unless that picture contains too much
information.
Keep it simple intentionally omitting details.`),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("strong",{parentName:"p"},`3. Coherent`)),(0,esm/* mdx */.kt)("p",null,`The documentation tells a story. Every section should integrate naturally without making the reader switch between
...
animations, and all the visual elements we include, should support the story we are telling.`),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("strong",{parentName:"p"},`4. Explicit`)),(0,esm/* mdx */.kt)("p",null,`Go straight to the point without assuming the readers should know about something. Again, link internal or external
resources to clarify.`),(0,esm/* mdx */.kt)("p",null,`The index of the whole content must be visible all the time so the reader knows exactly where they are and what is left.`),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("strong",{parentName:"p"},`5. Attractive`)),(0,esm/* mdx */.kt)("p",null,`Our text must be nice to read, our diagrams delectable to see, and our site… a feast for the eyes!!`),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("strong",{parentName:"p"},`6. Inclusive`)),(0,esm/* mdx */.kt)("p",null,`Everybody should understand our writings, especially the topics at the top. We have arranged the documentation structure
in a way that anybody can dig
deeper by just going down so, sections 1 to 4 must be suitable for all ages.`),(0,esm/* mdx */.kt)("p",null,`Use gender-neutral language to avoid the use of he, him, his to refer to undetermined gender. It is better to use their
or they as a gender-neutral
approach than s/he or similars.`),(0,esm/* mdx */.kt)("p",null,(0,esm/* mdx */.kt)("strong",{parentName:"p"},`7. Cohesive`)),(0,esm/* mdx */.kt)("p",null,`Writing short and concise sentences is good, but remember to use proper connectors (“Therefore”, “Besides”, “However”,
...
a robot with unnatural stops.`),(0,esm/* mdx */.kt)("h4",{"id":"practices"},`Practices`),(0,esm/* mdx */.kt)("p",null,`There are many writing styles depending on the type of document. It is common within technical and scientific writing to
