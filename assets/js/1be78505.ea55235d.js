"use strict";
(self["webpackChunkellmental"] = self["webpackChunkellmental"] || []).push([[9514,4972],{
...
;// CONCATENATED MODULE: ./src/theme/DocSidebarItem/Link/index.js
function LinkWrapper(props){// useEffect(() => {
//   if (itemProps.className?.includes("codetag-sidebar")) {
//     console.table(props.item)
//   }
// }, [])
const itemProps=props.item;const tag=itemProps.customProps?.tag;const name=itemProps.customProps?.name;if(!tag||!name){return/*#__PURE__*/react.createElement(react.Fragment,null,/*#__PURE__*/react.createElement(DocSidebarItemLink,props));}return/*#__PURE__*/react.createElement(DocSidebarCodeItemLink,props);}function DocSidebarCodeItemLink(_ref){let{item,onItemClick,activePath,level,index,...props}=_ref;const{href,label,className,autoAddBaseUrl,customProps}=item;const tag=customProps?.tag;const name=customProps?.name;const isActive=(0,docsUtils/* isActiveSidebarItem */._F)(item,activePath);const isInternalLink=(0,isInternalUrl/* default */.Z)(href);return/*#__PURE__*/react.createElement("li",{className:(0,clsx_m/* default */.Z)(ThemeClassNames/* ThemeClassNames */.k.docs.docSidebarItemLink,ThemeClassNames/* ThemeClassNames */.k.docs.docSidebarItemLinkLevel(level),'menu__list-item',className),key:label},/*#__PURE__*/react.createElement(Link/* default */.Z,(0,esm_extends/* default */.Z)({className:(0,clsx_m/* default */.Z)('menu__link',!isInternalLink&&styles.menuExternalLink,{'menu__link--active':isActive}),autoAddBaseUrl:autoAddBaseUrl,"aria-current":isActive?'page':undefined,to:href},isInternalLink&&{onClick:onItemClick?()=>onItemClick(item):undefined},props),/*#__PURE__*/react.createElement("span",{style:{opacity:0.65,paddingRight:'5px',fontFamily:'monospace'}},tag),/*#__PURE__*/react.createElement("span",{style:{fontFamily:'monospace'}},name),!isInternalLink&&/*#__PURE__*/react.createElement(ExternalLink/* default */.Z,null)));}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function DocSidebarItem(_ref){let{item,...props}=_ref;switch(item.type){case'category':return/*#__PURE__*/react.createElement(DocSidebarItemCategory,(0,esm_extends/* default */.Z)({item:item},props));case'html':return/*#__PURE__*/react.createElement(DocSidebarItemHtml,(0,esm_extends/* default */.Z)({item:item},props));case'link':default:return/*#__PURE__*/react.createElement(LinkWrapper,(0,esm_extends/* default */.Z)({item:item},props));}}
